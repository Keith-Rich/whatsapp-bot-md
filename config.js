...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '5_6_928a_2e01_2054').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'ᴍʀ.ꜱᴜᴘᴇʀᴍᴀɴ',
  ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE),
  LOG_MSG: toBool(process.env.LOG_MSG) || false,
  RMBG_KEY: process.env.RMBG_KEY || 'R7k6BCfrxnZ2DFEvW1VymZvM',
  ...
  KOYEB_API: (process.env.KOYEB_API || '78pwjn24odlnpsie49i5exya1sqz9eqeb0fi6td3nd5u215y6fpg0bk0qtt5yr5v').trim(),
  ...
  ANTI_BOT_MESSAGE: process.env.ANTI_BOT_MESSAGE || '&mention removed for being a cheap knock-off',
  WARN_MESSAGE:
